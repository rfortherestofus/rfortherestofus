...
#' @param dir A character string specifying the directory in the GitHub repository to search. Default is `"_targets/objects/"`.
#' @return A character vector of file paths that match the pattern, or an error if the directory listing fails.
#' @export
get_files <- function(pattern, dir = "_targets/objects/") {
